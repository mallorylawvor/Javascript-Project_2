...
function my_Function2() {
    document.getElementById("New_and_This").innerHTML = "Amy is a " + Amy.Person_Age + "Female, with " + Amy.Person_EyeColor + "eys" + "with hair color " + Amy.Person_Hair;
}
//new and this  constructor function 
